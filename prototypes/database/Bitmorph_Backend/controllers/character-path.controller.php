...
$methods['run'] = function($instance) {
	...
	switch($mode){
		case "explore":
			...
			<img class=\"bigImg\" src=\"http://osc.rtanewmedia.ca/character-image/". $characterID ."/600\"/> </div><div class=\"col-lg-4\"><h3>How this Bitmorph was created</h3><div id=\"infoBoxContainer\">";
		...
		case "tracking":
				echo "<div class=\"col-lg-4\" id=\"trackingBox\"><h3>How this Bitmorph was created</h3><div id=\"infoBoxContainer\">";
			foreach ($result as $state => $output) {
        			echo "<a href=\"" . $output["link"] . "\"><div class=\"infoBox\"><img src=\"/OSC/img/" . $output["front_sprite_filename"] . "\"><h3>" . $output["name"] . "</h3></div></a>";
			}
			echo  "</div></div>";
